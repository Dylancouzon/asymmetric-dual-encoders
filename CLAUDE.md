...
- [ ] M12 (**blocked on M10**, created 2026-09-03 by the renumbering below): the nano half of the pair — release `constella-nano`, its ONNX port, its FastEmbed registration, and the whitepaper carrying the comparator table the model cards deliberately omit. `instructions-m12.md`. **The upstream FastEmbed PR for the two ALREADY-published models is not blocked on M10** and can be opened whenever Dylan wants.
