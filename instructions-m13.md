# M13 — image model (noted, not scoped)

See `CLAUDE.md` M13 entry: an IMAGE asymmetric dual encoder, scoped once the text pair ships (M11 closed 2026-09-03; the nano half is M12). Do not inherit
the text pair's architecture assumptions.

## Use-case scoping (added 2026-09-02, Dylan)

M13's fit is fixed vocabulary, frozen document collection: query encoder and index both baked at
...
"it's on the edge." The camera/sensor case is the closest fit to M13's vision premise; the others
