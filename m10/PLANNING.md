...
- **Qdrant 1.18 (TurboQuant) and 1.19 (TurboQuant 4-bit as primary storage, cold/cached/pinned
  memory tiers, per-tenant IDF)**: index-side levers for the M12 all-in quantization comparison
...
| 9 | co-training the tower recorded as the M12 candidate | every ≥ 96% near-zero-query system co-trained the document side | §7 |
