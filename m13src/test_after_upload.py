...
import m13_after_upload as handoff
...
def test_unconfirmed_child_is_dead_before_stop(tmp_path,monkeypatch):
    ...
    try:
        ...
        assert requests==[(f'https://rest.runpod.io/v1/pods/{handoff.recovery.PODS[-1]}/stop','POST'),
                          (f'https://rest.runpod.io/v1/pods/{handoff.recovery.PODS[-1]}','GET')]
    finally:
