...
| `development-sensitivity-amendment-2026-09-13.md`, `../m19src/sensitivity.py`, `../results/m19_development_sensitivity.json` | post-hoc development-only exact bounds over persistent judgment uncertainty |
