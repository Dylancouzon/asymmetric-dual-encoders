...
> **Compacted 2026-08-28 (fifth time), 21K tokens → ~7K.** Every protocol fact and every
...
> `git log -p m7/LEDGER.md`. **The 4K budget was not reached and should not be**: getting there
> means deleting a pre-registered bar, which is the one thing this file exists to prevent.
