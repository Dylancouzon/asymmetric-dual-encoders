...
| **Direct dense-Gram ridge at V ≥ 50K** | 20.3 GB fp64 at 50,368 rows against an 18 GB budget — the arithmetic that closed granite-r2 and gte-modernbert in M7. | Reopened tonight by `m8src/blockcg.py`, which never forms the Gram. B7 measures whether the reopening holds at 64K and 128K. |
