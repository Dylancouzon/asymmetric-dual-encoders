# Brief: adversarial implementation review of `m17src/` (M17 step 4, review 2 of 2)
...
later step produces. This review is the second of the two independent implementation reviews (you have not seen the first; do not try to find it) that the
...
- The held-out alias test, panel screen/seal, alias pool and support manifest were regenerated today after code fixes; the result files named above are the current ones.
